...
const AddJobPage = ({ addJobSubmit }) => {
  ...
  const submitForm = async (e) => {
    ...
    try {
      // Call the addJobSubmit function and wait for it to complete
          ...
          <form onSubmit={submitForm}>
            ...
            <div className="mb-4">
              ...
              <input
                ...
                placeholder="eg. Software Developer Position"
                required
                value={title}
            ...
            <div>
              <button
                className={`w-full font-bold py-2 px-4 rounded-full focus:outline-none focus:shadow-outline ${
                  loading 
